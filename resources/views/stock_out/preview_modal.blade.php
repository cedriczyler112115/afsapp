    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Issuance Summary & Certification</h5>
            ...
            <div class="modal-body">
                ...
                <div class="mt-3">
                    <label for="issuance-purpose" class="form-label fw-bold">Purpose:</label>
                    <textarea class="form-control" id="issuance-purpose" rows="3" placeholder="Enter the purpose for this issuance..."></textarea>
                </div>
            </div>
