...
<body class="d-flex flex-column min-vh-100 bg-light">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between responsive-container">
            <div class="d-flex align-items-center gap-3">
                <button class="btn btn-outline-light" type="button" data-bs-toggle="offcanvas"
                    data-bs-target="#sideMenu" aria-controls="sideMenu">Menu</button>
                <a class="navbar-brand mb-0 h1" href="{{ route('dashboard') }}">PANTAWID AFS-IS</a>
            </div>
            <div class="d-flex align-items-center gap-3 ms-auto">
                <div class="dropdown">
                    <button class="btn btn-outline-light btn-sm dropdown-toggle" type="button" id="languageMenu"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="languageMenu">
                        ...
                        <li><a class="dropdown-item @if(app()->getLocale() === 'fil') active @endif"
                                href="{{ route('locale.set', ['locale' => 'fil']) }}">Filipino</a></li>
                    </ul>
                </div>
    ...
    <style>
        ...
        .loading-dots::after {
            ...
            width: 1.5em;
            /* Ensure enough width for 3 dots */
            text-align: left;
        }
