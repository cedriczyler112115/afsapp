...
<head>
    ...
    <title>Verify OTP - Stock Inventory Management System</title>
    ...
    <style>
        ...
        .form-control { border-radius: 14px; padding: 12px 14px; text-align: center; font-size: 24px; letter-spacing: 4px; }
...
<main class="auth">
    <div class="auth-card">
        ...
        <p class="text-secondary mb-4">Enter the 6-digit OTP sent to your email.</p>
        ...
        <form action="{{ route('password.otp.submit') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="otp" class="form-label fw-bold small mb-1">One-Time Password</label>
                <input type="text" name="otp" class="form-control" id="otp" required autofocus maxlength="6">
            </div>
            <button class="btn btn-auth-primary" type="submit">Verify OTP</button>
        </form>
    </div>
</main>
</body>
