...
<head>
    ...
    <title>Report of Damage - Print</title>
...
<body>
    ...
    <div class="page">
        ...
        <div class="meta-info">
            <table class="table table-borderless">
                ...
                <tr>
                    <td style="width: 150px"><strong>Report No:</strong></td>
        ...
        <!-- Certification Text -->
        <div class="cert-text">
            <p>This is to report that the following items are found to be damaged, unserviceable, or otherwise unfit for use. These items are subject for inspection and disposal/repair according to office policies.</p>
        </div>
        ...
        <div class="cert-text">
             <p>The undersigned certifies that the above items have been physically inspected and verified as damaged/unserviceable.</p>
        </div>
        ...
        <div class="signatures clearfix">
            ...
            <div class="sig-block right">
                <p style="text-align: left;">Verified/Inspected by:</p>
                <br><br><br>
                <div class="text-center">
                    <span class="fw-bold text-uppercase" style="margin-bottom: 10px;"><input type="text" id="received_conformed_by" name="received_conformed_by" value="{{ $group->received_conformed_by }}" class="no-border" style="text-align: center;width: 400px;border:0;font-weight: bold;" placeholder="Name of Inspector/Supervisor"></span>
                    <div class="sig-line" style="margin-top: -10px"></div>
                    <small>Inspector/Supervisor Signature over Printed Name</small>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function saveReceiver() {
            ...
            fetch("{{ route('damaged-items.group.update-receiver', $group->id) }}", {
                method: 'POST',
                headers: {
            ...
            .catch(error => console.error('Error saving inspector:', error));
        }
