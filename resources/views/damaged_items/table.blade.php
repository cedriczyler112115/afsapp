        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="align-items: center !important;">
                    ...
                    @if($issuance->issuance_group_id)
                    <a href="{{ route('damaged-items.print', $issuance->issuance_group_id) }}" target="_blank" class="btn btn-sm btn-secondary text-white ms-1" title="Reprint Group">
            ...
            @empty
            <tr>
                <td colspan="10" class="text-center">No Damaged/Unserviceable Items Found</td>
            </tr>
            @endforelse
        </tbody>
